...
public class ModeSoloActivity extends AppCompatActivity {
    ...
    private void initializeObject(){
        ...
        mDefaultColor = ContextCompat.getColor(ModeSoloActivity.this, R.color.colorPrimary);
    ...
    public void openCapOptions(){
        PopupMenu popup = new PopupMenu(ModeSoloActivity.this, capStyle);
        popup.getMenuInflater().inflate(R.menu.cap_menu, popup.getMenu());

        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                Toast.makeText(ModeSoloActivity.this,"You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
